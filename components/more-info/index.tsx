    ...
    <Container>
      <ContainerAllTexts>
        <ContainerText>
          ...
          <BodyWhiteAnimText>
            Buscamos darte una voz, que puedas realizar reportes de calles cerca de tu vecindario
            que se encuentran en mal estado. Nosotros nos encargamos de avisar a las autoridades
            correspondientes para que se encarguen de reparar dichas calles. Una vez hayamos
            recibido la confiramción de que la calle ha sido reparada, envíaremos un aviso a todas
            las personas que se interesaron en el reporte.
          </BodyWhiteAnimText>
        </ContainerText>
        <ContainerText>
          <SubtitleWhiteAnimText>¿Cómo podrás reportar?</SubtitleWhiteAnimText>
          <BodyWhiteAnimText>
            Primeramente requerimos que te autentiques en nuestro sistema con un sencillo sistema de
            inicio de sesión, de esta manera podremos enfocarnos en la seriedad de tu reporte, luego
            obtendrás acceso a un mapa especializado para que puedas encontrar la calle con la
      ...
      <div>
        <ContainerImages>
          {urlsImages.map((i) => (
            <ShapeImage key={i} url={i} />
          ))}
        </ContainerImages>
        <ContainerNextPage>
          <ContainerVideoText>
            <BodyWhiteAnimText>
              A continuación podrá visualizar el funcionamiento, además de una breve explicación de
              cómo funciona nuestro sistema de reportes.
            </BodyWhiteAnimText>
          </ContainerVideoText>
          <ContainerButton onClick={() => push("/video")}>
